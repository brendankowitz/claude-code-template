...
ADR Compliance Check:
  ✅ ADR-XXXX: [Title] - Fully compliant
  🟡 ADR-YYYY: [Title] - Partial compliance, see findings
  ❌ ADR-ZZZZ: [Title] - Non-compliant, requires attention
```
...
- ✅ ADR alignment checked (if applicable)
- ✅ Implementation roadmap includes realistic phases
